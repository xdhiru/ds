...
class LL{
    ...
    void reverseLL(){
        Node* travellerNode=head;
        Node* helperNodefront=head;
        Node* helperNodeback=nullptr;
        while(helperNodefront!=nullptr){
            helperNodefront=travellerNode->next;
            travellerNode->next=helperNodeback;
            helperNodeback=travellerNode;
            travellerNode=helperNodefront;
        }
        head=helperNodeback;
    }
};
